...
var DAppClient = /** @class */ (function (_super) {
    ...
    function DAppClient(config) {
        ...
        _this.activePeerLoaded = _this.storage
            .get(__1.StorageKey.ACTIVE_PEER)
            .then(function (activePeerPublicKey) { return __awaiter(_this, void 0, void 0, function () {
            var p2pPeerManager, postmessagePeerManager, peer, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!activePeerPublicKey) return [3 /*break*/, 6];
                        p2pPeerManager = new __1.PeerManager(this.storage, __1.StorageKey.TRANSPORT_P2P_PEERS_DAPP);
                        postmessagePeerManager = new __1.PeerManager(this.storage, __1.StorageKey.TRANSPORT_POSTMESSAGE_PEERS_DAPP);
                        return [4 /*yield*/, p2pPeerManager.getPeer(activePeerPublicKey)];
                    case 1:
                        if (!((_b = (_c.sent())) !== null && _b !== void 0)) return [3 /*break*/, 2];
                        _a = _b;
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, postmessagePeerManager.getPeer(activePeerPublicKey)];
                    case 3:
                        _a = (_c.sent());
                        _c.label = 4;
                    case 4:
                    ...
                    case 5:
                        _c.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.setActivePeer(undefined)];
                    case 7:
                        _c.sent();
                        _c.label = 8;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        _c.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, this.activePeerLoaded];
                    case 5:
                        _c.sent();
                        return [3 /*break*/, 7];
                    case 6:
                                        ...
                                        __1.PostMessageTransport.getAvailableExtensions()
                                            ...
                                            return __generator(this, function (_e) {
                                                switch (_e.label) {
                                                    case 0:
                                                        _b = (_a = this.events).emit;
                                                        _c = [events_1.BeaconEvent.PAIR_INIT];
                                                        _d = {};
                                                        return [4 /*yield*/, p2pTransport_1.getPairingRequestInfo()];
                                                    case 1:
                                                        _d.p2pPeerInfo = _e.sent();
                                                        return [4 /*yield*/, postMessageTransport_1.getPairingRequestInfo()];
                                                    case 2:
                                                        _b.apply(_a, _c.concat([(_d.postmessagePeerInfo = _e.sent(),
                                                                _d.preferredNetwork = this.preferredNetwork,
                                                                _d.abortedHandler = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [4 /*yield*/, this.storage.set(__1.StorageKey.ACTIVE_PEER, peer ? peer.publicKey : undefined)];
                    case 6:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (!beaconError.errorType) return [3 /*break*/, 4];
                        buttons = [];
                    ...
                    case 2:
                        activeAccount = _e.sent();
                        _b = (_a = this.events).emit;
                        _c = [beacon_message_events_1.messageEvents[request.type].error];
                        _d = { errorResponse: beaconError };
                        return [4 /*yield*/, this.getWalletInfo(peer, activeAccount)];
                    case 3:
                        _b.apply(_a, _c.concat([(_d.walletInfo = _e.sent(), _d), buttons]))
    ...
    DAppClient.prototype.getWalletInfo = function (peer, account) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var selectedAccount, _e, selectedPeer, _f, walletInfo, typedPeer, selectedApp;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                    ...
                    case 8:
                        ...
                        selectedApp = (_c = (_b = (_a = wallet_lists_1.iOSList.find(function (app) { return app.name === (walletInfo === null || walletInfo === void 0 ? void 0 : walletInfo.name); })) !== null && _a !== void 0 ? _a : wallet_lists_1.webList.find(function (app) { return app.name === (walletInfo === null || walletInfo === void 0 ? void 0 : walletInfo.name); })) !== null && _b !== void 0 ? _b : wallet_lists_1.desktopList.find(function (app) { return app.name === (walletInfo === null || walletInfo === void 0 ? void 0 : walletInfo.name); })) !== null && _c !== void 0 ? _c : wallet_lists_1.extensionList.find(function (app) { return app.name === (walletInfo === null || walletInfo === void 0 ? void 0 : walletInfo.name); });
                        if (selectedApp) {
                            return [2 /*return*/, {
                        ...
                        this.events
                            ...
                            extraInfo: {
                                resetCallback: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.clearActiveAccount()];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
