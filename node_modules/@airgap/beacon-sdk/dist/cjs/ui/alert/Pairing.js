...
var Pairing = /** @class */ (function () {
    ...
    Pairing.getPairingInfo = function (pairingPayload, statusUpdateHandler, platform) {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 3:
                        ...
                        switch (activePlatform) {
                            case Platform.DESKTOP:
                                return [2 /*return*/, Pairing.getDesktopPairingAlert(pairingCode, statusUpdateHandler, postmessageSyncCode, preferredNetwork)];
                            case Platform.IOS:
    ...
    Pairing.getDesktopPairingAlert = function (pairingCode, statusUpdateHandler, postmessageSyncCode, network) {
        return __awaiter(this, void 0, void 0, function () {
            var availableExtensions, qrLink, _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, __1.availableTransports.availableExtensions];
                    case 1:
                        availableExtensions = _e.sent();
                        qrLink = get_tzip10_link_1.getTzip10Link('tezos://', pairingCode);
                        ...
                        _d = [wallet_lists_1.desktopList.map(function (app) { return ({
                                ...
                                enabled: true,
                                clickHandler: function () {
                                    var link = get_tzip10_link_1.getTzip10Link(app.deepLink, pairingCode);
                    ...
                    case 2: return [2 /*return*/, (_a.walletLists = _b.concat([
                            (_c.wallets = __spreadArrays.apply(void 0, _d.concat([(_e.sent())])),
                                _c)
                        ]),
                            _a.buttons = [],
                            _a.qrData = qrLink,
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        _b = [{
                                ...
                                type: WalletType.IOS,
                                wallets: wallet_lists_1.iOSList.map(function (app) { return ({
                                    name: app.name,
                                    shortName: app.shortName,
                                    color: app.color,
                                    logo: app.logo,
                                    ...
                                    clickHandler: function () {
                                        var _a;
                                        var link = get_tzip10_link_1.getTzip10Link((_a = app.deepLink) !== null && _a !== void 0 ? _a : app.universalLink, pairingCode);
                    ...
                    case 1: return [2 /*return*/, (_a.walletLists = _b.concat([
                            (_c.wallets = __spreadArrays.apply(void 0, [(_d.sent())]),
                                _c)
                        ]),
                            _a.buttons = [],
                            _a.qrData = qrLink,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1: return [2 /*return*/, (_a.walletLists = [
                            (_b.wallets = __spreadArrays.apply(void 0, [(_c.sent())]),
                                _b)
                        ],
                            _a.buttons = [
                                {
    ...
    Pairing.getWebList = function (pairingCode, statusUpdateHandler, network) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, wallet_lists_1.webList.map(function (app) { return ({
                        name: app.name,
                        shortName: app.shortName,
                        color: app.color,
                        logo: app.logo,
                        ...
                        clickHandler: function () {
                            var _a;
                            var link = get_tzip10_link_1.getTzip10Link((_a = app.links[network]) !== null && _a !== void 0 ? _a : app.links[__1.NetworkType.MAINNET], pairingCode);
                            window.open(link, '_blank');
