...
var showPairAlert = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, serializer.serialize(data.p2pPeerInfo)];
            case 1:
                p2pBase58encoded = _a.sent();
                return [4 /*yield*/, serializer.serialize(data.postmessagePeerInfo)];
            case 2:
                postmessageBase58encoded = _a.sent();
                alertConfig = {
