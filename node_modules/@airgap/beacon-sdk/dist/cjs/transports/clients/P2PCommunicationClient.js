...
var clientNotReadyError = function () {
...
var P2PCommunicationClient = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.client.joinRooms(roomId)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    P2PCommunicationClient.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loginRawDigest, rawSignature, relayServer, _a, _b, _c, _d, _e, _f, _g, _h, invitedRooms;
            var _j;
            var _this = this;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        _a = this.getRelayServer;
                        return [4 /*yield*/, this.getPublicKeyHash()];
                    case 2: return [4 /*yield*/, _a.apply(this, [_k.sent(), '0'])];
                    case 3:
                        relayServer = _k.sent();
                        this.client = MatrixClient_1.MatrixClient.create({
                        ...
                        this.client.subscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE, this.initialListener);
                        this.client.subscribe(MatrixClientEvent_1.MatrixClientEventType.INVITE, function (event) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.tryJoinRooms(event.content.roomId)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                        ...
                        return [4 /*yield*/, this.getPublicKeyHash()];
                    case 4:
                        _c.apply(_b, _d.concat([_k.sent(), 'on', relayServer]));
                        _f = (_e = this.client).start;
                        _g = {};
                        return [4 /*yield*/, this.getPublicKeyHash()];
                    case 5:
                        _g.id = _k.sent();
                        _h = "ed:" + crypto_1.toHex(rawSignature) + ":";
                        return [4 /*yield*/, this.getPublicKey()];
                    case 6: return [4 /*yield*/, _f.apply(_e, [(_g.password = _h + (_k.sent()),
                                _g.deviceId = crypto_1.toHex(this.keyPair.publicKey),
                                _g)])
                            .catch(function (error) { return logger.log(error); })];
                    case 7:
                        _k.sent();
                        return [4 /*yield*/, this.client.invitedRooms];
                    case 8:
                        invitedRooms = _k.sent();
                        return [4 /*yield*/, (_j = this.client).joinRooms.apply(_j, invitedRooms).catch(function (error) { return logger.log(error); })];
                    case 9:
                        _k.sent();
                        return [2 /*return*/];
                }
    ...
    P2PCommunicationClient.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.client) {
                    this.client.stop().catch(function (error) { return logger.error(error); });
                }
                return [2 /*return*/];
            });
        });
    ...
    P2PCommunicationClient.prototype.listenForEncryptedMessage = function (senderPublicKey, messageCallback) {
        return __awaiter(this, void 0, void 0, function () {
            var sharedRx, callbackFunction, lastEvent;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (!(payload &&
                                            payload.length >= sodium.crypto_secretbox_NONCEBYTES + sodium.crypto_secretbox_MACBYTES)) return [3 /*break*/, 6];
                                        _b.label = 3;
                                    case 3:
                                        _b.trys.push([3, 5, , 6]);
                        ...
                        this.client.subscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE, callbackFunction);
                        lastEvent = this.initialEvent;
                        if (!(lastEvent &&
                            lastEvent.timestamp &&
                            new Date().getTime() - lastEvent.timestamp < 5 * 60 * 1000)) return [3 /*break*/, 3];
                    ...
                    case 4:
                        if (this.initialListener) {
                            this.client.unsubscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE, this.initialListener);
                        }
    ...
    P2PCommunicationClient.prototype.unsubscribeFromEncryptedMessage = function (senderPublicKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.client.unsubscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE, listener);
    ...
    P2PCommunicationClient.prototype.unsubscribeFromEncryptedMessages = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.client.unsubscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.createCryptoBoxClient(peer.publicKey, this.keyPair.privateKey)];
                    case 1:
                    ...
                    case 4:
                        ...
                        //   await new Serializer().deserialize(message)
                        // )
                        this.client.sendTextMessage(roomId, encryptedMessage).catch(function (error) { return __awaiter(_this, void 0, void 0, function () {
                            var newRoomId;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(error.errcode === 'M_FORBIDDEN')) return [3 /*break*/, 3];
                                        // Room doesn't exist
                                    ...
                                    case 2:
                                        ...
                                        this.client.sendTextMessage(newRoomId, encryptedMessage).catch(function (error2) { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
    ...
    P2PCommunicationClient.prototype.listenForChannelOpening = function (messageCallback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.client.subscribe(MatrixClientEvent_1.MatrixClientEventType.MESSAGE, function (event) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.getRoomById(roomId)];
                    case 1:
                        room = _a.sent();
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        // Before we send the message, we have to wait for the join to be accepted.
                        _d.sent();
                        if (!(typeof pairingRequest.version === 'undefined')) return [3 /*break*/, 5];
                    ...
                    case 8:
                        ...
                        this.client.sendTextMessage(roomId, msg).catch(function (error) { return __awaiter(_this, void 0, void 0, function () {
                            var newRoomId;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        this.client.sendTextMessage(newRoomId, msg).catch(function (error2) { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                logger.log("sendMessage", "inner error", error2);
                                                return [2 /*return*/];
                                            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.joinedRooms];
                    case 1:
                        joinedRooms = _a.sent();
                        ...
                        if (!(relevantRooms.length === 0 || this.ignoredRooms.length > 0)) return [3 /*break*/, 4];
                        logger.log("getRelevantJoinedRoom", "no relevant rooms found, creating new one");
                        return [4 /*yield*/, this.client.createTrustedPrivateRoom(recipient)];
                    case 2:
                        roomId = _a.sent();
                        return [4 /*yield*/, this.client.getRoomById(roomId)];
                    case 3:
